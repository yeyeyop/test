...
$(document).ready(function() {
   ...
   $("#btnWrite").on("click", function() {
      ...
      var form = $("#writeForm")[0];  //폼 아이디의 0번째 값을 
      var formData = new FormData(form);    //폼데이터로 만들어서 넘긴다
      ...
      $.ajax({
           ...
           cache: false,
           timeout: 600000,
           beforeSend : function(xhr) //리퀘스트 하기 전에 얘부터 실행해라
           {
               xhr.setRequestHeader("AJAX", "true");  //나아작스야
           },
           success: function (response) //성공일 때
           {
              if(response.code == 0)
              {
                 alert("게시물이 등록되었습니다.");
