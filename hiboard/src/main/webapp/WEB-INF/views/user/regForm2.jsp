        ...
        <div class="col-12">
            <form id="regForm2" method="post">
                <div class="form-group">
                    <label for="userId2">사용자 아이디</label>
                    <input type="text" class="form-control" id="userId2" name="userId2" placeholder="사용자 아이디" maxlength="12" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="userName2" name="userName2" placeholder="사용자 이름" maxlength="15" />
                </div>
                <div class="form-group">
                    <label for="userEmail2">사용자 이메일</label>
                    <input type="text" class="form-control" id="userEmail2" name="userEmail2" placeholder="사용자 이메일" maxlength="30" />
                </div>
                <div class="form-group">
                    <label for="gender2">사용자 성별</label>
                    <input type="text" class="form-control" id="gender2" name="gender2" placeholder="사용자 성별" maxlength="30" />
                </div>
                <div class="form-group">
                    <label for="userBirth2">사용자 나이</label>
                    <input type="text" class="form-control" id="userBirth2" name="userBirth2" placeholder="사용자 나이" maxlength="30" />
                </div>
                <input type="hidden" id="userPwd2" name="userPwd2" value="" />
                <button type="button" id="btnReg2" class="btn btn-primary">등록</button>
            </form>
        </div>
    </div>
</div>
