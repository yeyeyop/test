    ...
    <div class="row mt-2">
        <div class="col-12">
            <form id="regForm" method="post">
                ...
                <div class="form-group">
                    <label for="gender">사용자 성별</label>
                    <input type="text" class="form-control" id="gender" name="gender" placeholder="사용자 성별" maxlength="30" />
                </div>
                <div class="form-group">
                    <label for="userAge">사용자 나이</label>
                    <input type="text" class="form-control" id="userAge" name="userAge" placeholder="사용자 나이" maxlength="30" />
                </div>
